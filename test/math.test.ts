...
describe('数学函数单元测试', () => {
  it('加法测试', () => {
    let 加法函数 = new 函数(加法算子, new 数据([new 值(1), new 值(2)]))
    expect(加法函数.求值()).toBe(3)
    expect(加法函数.输出文本()).toBe('(1 + 2)')
  })

  it('减法测试', () => {
    let 减法函数 = new 函数(减法算子, new 数据([new 值(10), new 值(4)]))
    expect(减法函数.求值()).toBe(6)
    expect(减法函数.输出文本()).toBe('(10 - 4)')
  })

  it('乘法测试', () => {
    let 乘法函数 = new 函数(乘法算子, new 数据([new 值(3), new 值(4)]))
  ...
  it('除法测试', () => {
    let 除法函数 = new 函数(除法算子, new 数据([new 值(10), new 值(2)]))
  ...
  it('嵌套函数测试', () => {
    // (1 + 2) * 3
    let 我的函数 = new 函数(乘法算子, new 数据([new 函数(加法算子, new 数据([new 值(1), new 值(2)])), new 值(3)]))
